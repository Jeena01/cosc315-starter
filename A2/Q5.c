// Copy your completed Q4.c to this file.
// Your job consists of removing the need for a lock from the code.
// HINT: Think locally before globally...
// +5
#include <stdio.h> 
#include <stdlib.h>
